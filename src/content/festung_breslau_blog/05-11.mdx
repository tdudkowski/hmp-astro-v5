...
- Dodałem zupełnie nowy element uzupełniający blog wojenny - wspomnienia więźniarki wrocławskiego Gestapo, Marii Langner, książka prawie zapomniana, wydana w Polsce raz w 1951 i cytowana w kilku źródłach [Maria Langner "Ostatni bastion"](/maria-langner).
- Więcej cytatów, głównie z książki Ryszarda Majewskiego "Dolny Śląsk 1945 Wyzwolenie".
- Dziesiątki uzupełnień i korekt.
- Bibliografia, w granicach możliwości kompletna, do tego wreszcie rozpisana w JSON-ie, więc łatwa do zarządzania i aktualizacji.
- Przeniesienie bloga, ba! całej strony z Gatsby'ego, który przestał być rozwijany 2023 na inny framework: Astro.

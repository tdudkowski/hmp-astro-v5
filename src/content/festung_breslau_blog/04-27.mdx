...
description: "Berlin atakowany zewsząd. Od zachodu sowieci doszli do Haweli, od południa do Kanału Landwehry, od wschodu są w rejonie Alexanderplatz. Mają mniej niż kilometr do bunkra Hitlera! Bunkier stracił łączność.
...
{/* <FBBoxImageWrapper>
![Pétain](../../assets/images/fbimages/Bundesarchiv_Bild_183-H25217,_Henry_Philippe_Petain_und_Adolf_Hitler.jpg)
...
<FBBoxImageWrapper>
![Plac Poczdamski](../../assets/images/fbimages/Bundesarchiv_Bild_183-R71639,_Berlin,_Panzersperre_am_Potsdamer_Platz.jpg)
...
Filia KL Dachau znajdująca się w Hurlach (Bawaria) przeznaczona dla lotników alianckich zestrzelonych nad Niemcami. Jeńcy wojenni byli wykorzystywani do produkcji wunderwaffe, czyli samolotów odrzutowych  Me 262 i rakiet balistycznych V2

Na wieść o zbliżaniu się wojsk amerykańskich SS dokonało egzekucji kilkuset jeńców, ci w lepszym stanie byli przeznaczeni do "eewakuacji" czyli marszu śmierci do KL Dachau.

Obóz i jego wyzwolenie są utrwalone w kulturze masowej przez słynne zdjęcie, na którym komendant obozu Otto Förschner stoi pośród ofiar.

W Kompani Braci o wyzwoleniu tego obozu opowiada odcinek "Dlaczego walczymy".

### Samobójstwa hitlerowców

Hitlerowcy się zabijają:

Hans Schleif, architekt, archeolog, SS-man. Był badaczem mającym międzynarodową reputację, nie był gorliwym hitlerowskim wandalem i nie wykonywał wszystkich zaleceń Gestapo.

Dziś o 1100 w Berlinie zabił swoich synów bliźniaków i drugą żonę, którą poznał jako asystentkę z ramienia Ahnenerbe, a na końcu siebie.

Dołączył do niego Max Blancke, lekarz SS, który na Majdanku przeprowadzał selekcje więźniów do komór gazowych. W KL Plaszow dokonywał selekcji niezdolnych do pracy, którzy byli wywożeni do KL Auschwitz. Jego trzecim obozem był Kaufering IV początkowo obóz jeniecki dla zestrzelonych lotników alianckich, potem obóz pracy. Tam wziął udział w egzekucji 350 więźniów chorych na tyfus, dla zatarcia śladów spalono ich żywcem. Miało to umożliwić skuteczną "ewakuację" reszty więźniów.

Dziś wieczorem razem z żoną popełnili samobójstwo w swoim domu w Hurlach (Bawaria).

- [Hans Schleif](https://en.wikipedia.org/wiki/Hans_Schleif)
- [Max Blancke](https://pl.wikipedia.org/wiki/Max_Blancke)

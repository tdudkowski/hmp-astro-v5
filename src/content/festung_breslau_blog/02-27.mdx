...
description: "RAF wysłał bombowce, żeby zniszczyły węzeł kolejowy w Moguncji. Zginęło 1200 ludzi.
...
W gazecie frontowej instrukcja użycia panzerfausta. Broń tak prosta, że mogły jej używać i czasem używały dzieci. Mówiono, że broń i jej operator jest jednorazowego użytku. Ludowe wunderwaffe, które miało wyrównać szanse pospolitego ruszenia. Historia panzerfausta i panzerschrecka.
...
Jak się okazuje, zasadniczy cel operacji, węzeł kolejowy, został tylko uszkodzony. Już trzy dni po nalocie pociągi jeździły przez Moguncję.

### Augsburg

Bombardowanie Augsburga, celem było dopełnienie skutków poprzednich bombardowań z 22 i 23 lutego, w ramach operacji Clarion, której celem było niszczenie infrastruktury komunikacyjnej w centralnych Niemczech. Głównie chodziło o dworce kolejowe, mosty, porty i drogi.

Bombardowanie dotknęło centralną dzielnicę Hochfeld, zginęło 172 ludzi.

- [https://de.wikipedia.org/wiki/Luftangriffe_auf_Augsburg](https://de.wikipedia.org/wiki/Luftangriffe_auf_Augsburg)
- [Operation Clarion](https://en.wikipedia.org/wiki/Operation_Clarion)
- Zestrzelony amerykański B-17, brał udział w bombardowaniu Augsburga.  ["Crash site US B-17 Fortreess "Dottie" 97th Bomb Group, 414th Squadron February 27, 1945 Trimbach / Switzerland"](https://standwheretheyfought.jimdofree.com/b-17-flying-fortress-crash-in-trimbach-switzerland-february-27-1945-then-and-now/)
...
>Celem działań zaczepnych 17 Armii (której dowództwo po zranieniu pod koniec lutego generała F. Schulza objął przejściowo generał W. Nehring, dowódca XXIV Korpusu Pancernego) było z jednej strony odblokowanie ważnych linii kolejowych, niezbędnych do zaopatrywania wojsk hitlerowskich w ostatnich tygodniach wojny, z drugiej zaś uzyskanie dogodnej podstawy wyjściowej do przyszłej deblokady Wrocławia.<br />
>Pierwszą z tych operacji przeprowadzono na prawym brzegu Kwisy w rejonie Lubania, na którego północno-wschodnich krańcach jednostki radzieckiej 52 Armii w dalszym ciągu utrzymywały pozycje zdobyte w końcowym etapie operacji dolnośląskiej. Uniemożliwiało to hitlerowcom wykorzystywanie ostatniej, jaką posiadali, linii kolejowej północ od Sudetów, biegnącej z Budziszyna przez Zgorzelec, Lubań, Jelenią Górę do Wałbrzycha i ostrawsko-karwińskiego zagłębia przemysłowego. Do przeprowadzenia tej operacji przekazano dowództwu Grupy Armii "Środek" dodatkowe siły z odwodów OKH, przede wszystkim zaś dwa elitarne związki pancerne: "Führer-Grenadierdivision" i "Führer-Begleitdivision”.<br />

I w przypisie:

>11 W meldunku do Hitlera z 27 lutego 1945 r. gen. Schörner w następujący sposób precyzował zadanie tej operacji: "Proponowane natarcie w rejonie Lubania daje następujące korzyści: 1) Rozbicie sił przeciwnika znajdujących się na południe od Nowogrodźca lub przynajmniej tak silne ich pobicie, by nie nadawały się do skutecznych działań bojowych; 2) Odzyskanie pilnie potrzebnego połączenia kolejowego ze Zgorzelca przez Lubań do Jeleniej Góry, co stanowi istotny warunek koncentracji sił dla deblokady Wrocławia" (MiD WIH, T. 78, R. 304).
...
<FBBoxImageWrapper>
![dziennik NSDAP z instrukcją używania panzerfausta](../../assets/images/fbimages/panzerfaust-zeitung.jpg)
...
- Podcast Wojenne Historie ["Panzerfaust. Pancerna pięść." [YT 43:54]](https://www.youtube.com/watch?v=wreNkBmbl94)

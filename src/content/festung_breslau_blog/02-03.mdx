...
tags: Bank Rzeszy, Berlin, bombardowanie, egzekucja, Filipiny, Freisler, Manila, Po-2, Raubgold, Reichsbank, Schacht, Ehrenhäftling, Langner, kryptologia, SIGABA
...
- [David Joyner "The Colmar Incident"](https://medium.com/@wdjoyner/the-colmar-incident-51512a11392f)
- Crypto Museum [SIGABA](https://www.cryptomuseum.com/crypto/usa/sigaba/index.htm)
- [Kahn, David "Łamacze kodów. Historia kryptologii"](https://sklep.zysk.com.pl/lamacze-kodow-historia-kryptologii.html)
- National Cryptologic Foundation ["On This Date in Cryptologic History" Calendar](https://cryptologicfoundation.org/community/bytes/this_day_in_history_calendar.html)

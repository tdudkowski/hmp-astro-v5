...
SÉA OMÉ 12 (na Première exposition d'électronique française, styczeń 1950) Opérateur Mathématique Électronique 12 był drugim komputerem analogowym zaprojektowanym przez Borisa Alexandre'a Sokoloffa i jednym z najwcześniejszych produktów wyprodukowanych przez Société d'Electronique et d'Automatisme (SÉA), produkt został wprowadzony na rynek w 1949 r.

SÉA była pierwszą rodzimą francuską firmą zajmującą się komputerami elektronicznymi. Została założona przez Francois Raymonda w 1948. W tym samym roku przeprowadzono badania dokładności na pierwszym prototypowym stanowisku testowym SÉA OMÉ 11. Wyniki laboratoryjne wykazały, że niestabilne wzmocnienie i szum elektroniczny były czynnikami ograniczającymi wzmacniacze operacyjne oparte na lampach elektronowych, wpływały niekorzystnie na stabilność i powtarzalność obliczeń.

Wyciągnięte z trzech lat doświadczenia zostały wykorzystane w komercyjnym OMÉ 12. Miał on specjalnie dla niego zbudowane precyzyjne oporniki, kondensatory o niskim upływnści, szybkich przekaźnikach, unikalnych ultrastabilnych regulatorach napięcia i samokalibrujących się wzmacniaczach operacyjnych. Maszyna była w stanie rozwiązać 10 liniowych równań algebraicznych lub pięć równań całkowo-różnicowych trzeciego rzędu. Pierwsza maszyna produkcyjna znajdowała się w Services Technique Aeronautique, która używała jej do projektowania systemów sterowania dla automatycznych pilotów, a później bardziej złożonego symulatora lotu Mistral działającego w czasie rzeczywistym.

- [SÉA O.M.É. 12](https://www.facebook.com/groups/779220482206901/posts/5898428516952713/)

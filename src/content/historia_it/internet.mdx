...
- ["Why did it take 16 hours for the first message to cross the atlantic via a cable?"](https://www.reddit.com/r/askscience/comments/pmehd2/why_did_it_take_16_hours_for_the_first_message_to/), [Równania telegrafistów](https://pl.wikipedia.org/wiki/R%C3%B3wnania_telegrafist%C3%B3w), [Transatlantic telegraph cable](https://en.wikipedia.org/wiki/Transatlantic_telegraph_cable)
- [ADAM SATARIANO "How the Internet Travels Across Oceans"](https://www.nytimes.com/interactive/2019/03/10/technology/internet-cables-oceans.html)
